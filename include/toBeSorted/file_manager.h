...
public:
    ...
    /* 0xA830 */ u16 mCurrentHealth[3];
    /* 0xA836 */ u16 mCurrentHealthCapacity[3];
...
public:
    ...
    /* 8000A2A0 */ u16 getFileCurrentHealth(int fileNum);
    /* 8000A2C0 */ u16 getFileHealthCapacity(int fileNum);
    ...
    /* 8000A730 */ void setStoryFlags(u16 *flags, u32 offset, s32 count);
    /* 8000A790 */ void setItemFlags(u16 *flags, u32 offset, s32 count);
    /* 8000A7F0 */ void setDungeonFlags(u16 *flags, u32 offset, s32 count);
    /* 8000A850 */ void setSceneFlags(u16 *flags, u32 offset, s32 count);
    /* 8000A8B0 */ void setTBoxFlags(u16 *flags, u32 offset, s32 count);
    /* 8000A910 */ void setTempFlags(u16 *flags, u32 offset, s32 count);
    /* 8000A970 */ void setZoneFlags(u16 *flags, u32 offset, s32 count);
    /* 8000A9D0 */ void setEnemyDefeatFlags(u16 *flags, u32 offset, s32 count);

    /* 8000AA30 */ u16 *getSkipFlags();
    /* 8000AA40 */ void setSkipFlagsChecked(u16 *flags, u32 offset, s32 count);

    /* 8000AAA0 */ void initFile(int fileNum);

    /* 8000ABD0 */ void setCurrentHealthCapacity(u16 health);
    /* 8000AC00 */ u16 getCurrentHealthCapacity();
    /* 8000AC50 */ void setCurrentHealth(u16 health);
    /* 8000AC80 */ u16 getCurrentHealth();

    /* 8000ACD0 */ u16 getLoadRoomT1();
    /* 8000AD20 */ u16 getLoadRoomT2();
    /* 8000AD70 */ void setLoadRoomT3(u16 room);
    ...
    /* 8000B540 */ u32 getItemCheckUpperData(u32 idx);
    ...
    /* 8000BE50 */ void setLoadRoomT1_FileB(u16 roomId);
    ...
    /* 8000C080 */ void setNightT1_FileB(u8 night);
    ...
    /* 8000C130 */ void setCurrentHealth_FileB(u16 health);
    ...
    /* 8000C930 */ u8 getEntranceT2();
    /* 8000C980 */ void setEntranceT3(u8 entrance);
    /* 8000C9B0 */ u8 getEntranceT3();

    /* 8000CA00 */ u8 getNightT1();
    /* 8000CA50 */ void setNightT3(u8 night);
    /* 8000CA80 */ u8 getNightT3();

    /* 8000CAD0 */ u8 isNew_FileA();

    /* 8000CB00 */ void setSceneFlagIndex(s16 idx);
    /* 8000CB30 */ s16 getSceneFlagIndex();
    ...
    /* 8000FE00 */ void copySkipData(u32 fileNum);
    /* 8000FEB0 */ void setInfo_FileB(u16 entrance, u16 room);
    ...
    /* 80011280 */ u32 calcFileCRC(const void *file, u32 length);
    /* 80011290 */ void updateEmptyFiles();
    /* 800112D0 */ void updateEmptyFileFlags();
    /* 80011370 */ u8 isFileEmpty(u32 fileNum);
    /* 80011390 */ u8 isFileDirty(u32 fileNum);
